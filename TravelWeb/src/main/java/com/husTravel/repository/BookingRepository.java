...
import com.husTravel.dto.BookingDetailDTO;
...
import com.husTravel.dto.BookingDTO;
import com.husTravel.entity.Booking;
...
public interface BookingRepository extends JpaRepository<Booking, Long>{
	...
	@Query(value = "SELECT new com.husTravel.dto.BookingDTO(b.id,b.user_id,b.tour_id,t.ten_tour,b.so_luong_nguoi,b.ngay_khoi_hanh,b.tong_tien,b.trang_thai,b.pt_thanh_toan,b.ghi_chu,b.booking_at ) "
	...
	@Query(value = "SELECT new com.husTravel.dto.BookingDetailDTO(b.id,b.user_id,u.ho_ten,u.sdt,b.tour_id,t.ten_tour,b.so_luong_nguoi,b.ngay_khoi_hanh,b.tong_tien,b.trang_thai,b.pt_thanh_toan,b.ghi_chu,b.booking_at) "
